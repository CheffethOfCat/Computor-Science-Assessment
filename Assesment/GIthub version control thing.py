...
def append_name ():
    ...
    customer_details.append([entry_customer_name, entry_receipt_number, entry_item_hired, entry_number_hired])
    entry_customer_name.delete(0, 'end')
    entry_receipt_number.delete(0, 'end')
    entry_item_hired.delete(0, 'end')
    entry_number_hired.delete(0, 'end')
...
#Adjusted append system and improved upon it
def delete_row ():
...
#Made it so that user is unable to type letters or numbers into a specific entry box
